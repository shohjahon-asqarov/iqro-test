                            ...
                            <li className='p-5 py-12 sm:px-8 rounded-3xl bg-card-bg border border-[hsla(0,0%,87.5%,.7)] space-y-5 text-[rgba(2,11,18,.7)] relative overflow-hidden' key={currentQuestion.id}>
                                ...
                                <div className='space-y-5 flex flex-col'>
                                    {currentQuestion.answers.map((answer, index) => {
                                        return (
                                            <button onClick={() => nextQuestion(index)} className='bg-white py-3.5 px-5 group rounded-xl cursor-pointer active:bg-[#00A89D] active:text-white text-left duration-300 flex justify-between border-2 sm:hover:border-[#00A89D] animation-show' key={index}>
                                                <div>
                                                ...
                                                <i className='bi bi-check hidden group-active:flex sm:group-hover:flex bg-[#00A89D] rounded-full w-5 h-5 justify-center items-center text-white'></i>
                                            </button>
                                        )
                                    })}
                                </div>
                                ...
                                return (
                                    <li data-aos='fade-left' className='p-8 rounded-3xl bg-card-bg border border-[hsla(0,0%,87.5%,.7)] space-y-5 text-[rgba(2,11,18,.7)]' key={index}>
                                        ...
                                        {i.my_answer === i.correct_answer
                                            ? <ul>
                                                <li className='space-x-2 text-[#00A89D] font-medium'>
                                                    <i className='bi bi-check mr-2'></i>
